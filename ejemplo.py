...
# llevar a cabo 3 estados que son deuda, neto y ganancia. El Banco X, posee un algoritmo 
...
class Algoritmo_Banco():
  ...
  # Procesamiento para estado de pérdida
...
class Algoritmo_Sucursal_01(Algoritmo_Banco):
  ...
  def estado_ganacia(self):
      ...
      print("Tus ganancias serán consignadas en una cuenta de ahorros")
...
#El proceso de calcular el estado
